      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="form_lot.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="summary_lot.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Summary</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Summary Inspection by LOT</h1></br>
          </div></br><!-- /.col -->
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <table id="table" class="table table-bordered table-striped">
                  ...
                  ?>
                  <tr>
                    <td><a href="view_detailsLOT.php?RecordID=<?php echo $row['RecordID']?>&ByLot_ID=<?php echo $row['ByLot_ID']?>" class="btn btn-primary" target="_blank">View</a></td>
                    <td><?php echo $row['Batch_Number'];?></td>
                    <td><?php echo date('d/m/Y',strtotime($row['Inspection_Date']));?></td>
                    <td><?php echo $row['No_TravelForm'];?></td>
                    <td><?php echo $row['PalletNo'];?></td>
