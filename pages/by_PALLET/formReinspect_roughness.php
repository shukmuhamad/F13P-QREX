                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <input name="batchnumber" type="text" class="form-control"  value="<?php echo $row['Batch_Number'];?>" id="batchnumberRoughness" onInput="checkresult()" readonly> <!-- <span id="check-batchNo"></span> -->
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <select name="size" class="form-control select2" readonly>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <select class="form-control select2" name="productcode" readonly>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <select class="form-control select2" name="inspectionstage" readonly>
                              <option class="form-control" value= "3">Rework</option>
                            <select>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <input type="text" name="palletnumber" class="form-control" value="<?php echo $row['Pallet_Number'];?>" readonly>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-sm-2 col-form-label">Former Height</label>
                          <div class="col-sm-6">
                            <select class="form-control select2" name="formerheight"  value="<?php echo $row['Former_Height'];?>" readonly>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <select name="formertype" class="form-control select2" readonly>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <select class="form-control select2" name="coating" value="<?php echo $row['Coating'];?>" readonly>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <input type="text" name="rework" class="form-control" value="<?php echo $row['Rework'];?>" readonly>
                          </div>
                        </div>
                        <!-- /.form-group -->
                      </div>
