        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../by_LOT/summary_lot.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Summary</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="summary_roughness.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Summary</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Summary Inspection by Pallet: Roughness</h1></br>
          </div></br><!-- /.col -->
          <div class="col-12">
            <div class="card">
                ...
                <table id="table" class="table table-bordered table-striped">
                  ...
                  <?php 
                    if(isset($_POST['search'])){
                      ...
                      // echo $endDate;
                      // echo $batchNo;
                      // echo $inspectionStage;
                      //Query statements to select from view_1
                      $query = "{CALL SP_ViewListRoughness(?,?,?,?)}";
                  ...
                  ?>
                  <tr>
                    <td><a href="view_roughness.php?RecordID=<?php echo $row['RecordID']?>&Roughness_ID=<?php echo $row['Roughness_ID']?>" class="btn btn-primary" target="_blank">View</a></td>
                    <td><?php echo $row['Batch_Number'];?></td>
                    <td><?php echo date('d/m/Y',strtotime($row['Inspection_Date']));?></td>
                    <td><?php echo $row['Pallet_Number'];?></td>
