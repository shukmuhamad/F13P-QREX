        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="summary_glossiness.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Summary</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Summary Inspection by Pallet: Glossiness</h1></br>
          </div></br><!-- /.col -->
          <div class="col-12">
            <div class="card">
                ...
                <table id="table" class="table table-bordered table-striped">
                  ...
                  <?php 
                    if(isset($_POST['search'])){
                      ...
                      $query = "{CALL SP_ViewListGlossiness(?,?,?,?)}";
                  ...
                  ?>
                  <tr>
                    <td><a href="view_glossiness.php?RecordID=<?php echo $row['RecordID']?>&Glossiness_ID=<?php echo $row['Glossiness_ID']?>" class="btn btn-primary" target="_blank">View</a></td>
